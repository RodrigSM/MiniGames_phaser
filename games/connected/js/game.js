...
Game.Menu.prototype = {
  create: function() {
    ...
    var label_start = game.add.text(w / 2, h - 50, "liga os dois pontos para começar", {
      font: "20px Arial",
      fill: "#2c3e50"
    });
...
Game.End.prototype = {
  create: function() {
    ...
    game.add.text(w / 2, h / 2, "acabaste os 20 turnos\n\nmarcaste: " + score +
        "\ntu melhor pontuação: " + best_score, {
          font: "30px Arial",
          fill: "#2c3e50",
          align: "center"
        })
    ...
    label_restart = game.add.text(w / 2, h - 50, "clica em qualquer lugar para reiniciar", {
      font: "20px Arial",
      fill: "#2c3e50"
    });
