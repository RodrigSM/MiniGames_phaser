...
Game.Load.prototype = {
  preload: function() {
    ...
    label2 = game.add.text(Math.floor(w / 2) + 0.5, Math.floor(h / 2) - 15 + 0.5, 'a carregar...', {
      font: '30px Arial',
      fill: '#fff'
    });
...
Game.Menu.prototype = {
  create: function() {
    ...
    label = game.add.text(w / 2, h - 50, 'pressiona a tecla SETA PARA CIMA para começar', {
      font: '25px Arial',
      fill: '#fff'
    });
...
Game.Play.prototype = {
  ...
  displayScore: function(){
    this.labelScore = this.game.add.text(30, 30, 'pontuação: 0', {
      font: '16px Arial',
      fill: '#fff'
    });
    this.labelBestScore = this.game.add.text(30, 50, 'melhor: 0', {
      font: '16px Arial',
      fill: '#fff'
    });
    this.labelTutorial = this.game.add.text(30, h - 40, '1- usa as setas para te moveres\n2- apanha moedas para pontuar\n3- salta sobre os pinguins para os eliminar', {
      font: '18px Arial',
      fill: '#fff'
    });
    this.labelTutorial.anchor.setTo(0, 1);
    this.score = 0;
    this.bestScore = 0;
  },
  ...
  updateScore: function(value) {
    this.score += value;
    this.labelScore.text = 'pontuação: ' + this.score;
  },
  ...
  updateBestScore: function() {
    if (this.bestScore < this.score) {
      ...
      this.labelBestScore.content = 'melhor: ' + this.bestScore;
    ...
    this.score = 0;
    this.labelScore.content = 'pontuação: ' + this.score;
  },
};
